...
//    ui->dateLabel->setPalette(pe1);
    ui->dateLabel->setStyleSheet("color:rgb(95,95,95);");
}
...
void MainWindow::showImage()
{
    ...
    else if (idxShowImage.load() == queueShow.top().first)
    {
        ...
        QPixmap img1 = QPixmap::fromImage(imag);
        QPixmap pixMap= img1.scaled(560,560, Qt::IgnoreAspectRatio, Qt::SmoothTransformation);
        //50为圆形的半径
        pixMap =  PixmapToRound(pixMap, 280);
